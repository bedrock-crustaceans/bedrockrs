...
impl ActorType {
    pub fn to_string(self) -> String {
        match self {
            ActorType::Player => "player".to_string(),
            ActorType::ItemEntity => "item".to_string(),
            ActorType::PrimedTnt => "tnt".to_string(),
            ActorType::FallingBlock => "falling_block".to_string(),
            ActorType::MovingBlock => "moving_block".to_string(),
            ActorType::ExperiencePotion => "xp_orb".to_string(),
            ActorType::Experience => "xp_bottle".to_string(),
            ActorType::EyeOfEnder => "eye_of_ender_signal".to_string(),
            ActorType::Undefined => todo!(),
            ActorType::TypeMask => todo!(),
            ActorType::Mob => todo!(),
            ActorType::PathfinderMob => todo!(),
            ActorType::Monster => todo!(),
            ActorType::Animal => todo!(),
            ActorType::TamableAnimal => todo!(),
            ActorType::Ambient => todo!(),
            ActorType::UndeadMob => todo!(),
            ActorType::ZombieMonster => todo!(),
            ActorType::Arthropod => todo!(),
            ActorType::Minecart => todo!(),
            ActorType::SkeletonMonster => todo!(),
            ActorType::EquineAnimal => todo!(),
            ActorType::Projectile => todo!(),
            ActorType::AbstractArrow => todo!(),
            ActorType::WaterAnimal => todo!(),
            ActorType::VillagerBase => todo!(),
            ActorType::Chicken => todo!(),
            ActorType::Cow => todo!(),
            ActorType::Pig => todo!(),
            ActorType::Sheep => todo!(),
            ActorType::Wolf => todo!(),
            ActorType::Villager => todo!(),
            ActorType::MushroomCow => todo!(),
            ActorType::Squid => todo!(),
            ActorType::Rabbit => todo!(),
            ActorType::Bat => todo!(),
            ActorType::IronGolem => todo!(),
            ActorType::SnowGolem => todo!(),
            ActorType::Ocelot => todo!(),
            ActorType::Horse => todo!(),
            ActorType::PolarBear => todo!(),
            ActorType::Llama => todo!(),
            ActorType::Parrot => todo!(),
            ActorType::Dolphin => todo!(),
            ActorType::Donkey => todo!(),
            ActorType::Mule => todo!(),
            ActorType::SkeletonHorse => todo!(),
            ActorType::ZombieHorse => todo!(),
            ActorType::Zombie => todo!(),
            ActorType::Creeper => todo!(),
            ActorType::Skeleton => todo!(),
            ActorType::Spider => todo!(),
            ActorType::PigZombie => todo!(),
            ActorType::Slime => todo!(),
            ActorType::EnderMan => todo!(),
            ActorType::Silverfish => todo!(),
            ActorType::CaveSpider => todo!(),
            ActorType::Ghast => todo!(),
            ActorType::LavaSlime => todo!(),
            ActorType::Blaze => todo!(),
            ActorType::ZombieVillager => todo!(),
            ActorType::Witch => todo!(),
            ActorType::Stray => todo!(),
            ActorType::Husk => todo!(),
            ActorType::WitherSkeleton => todo!(),
            ActorType::Guardian => todo!(),
            ActorType::ElderGuardian => todo!(),
            ActorType::Npc => todo!(),
            ActorType::WitherBoss => todo!(),
            ActorType::Dragon => todo!(),
            ActorType::Shulker => todo!(),
            ActorType::Endermite => todo!(),
            ActorType::Agent => todo!(),
            ActorType::Vindicator => todo!(),
            ActorType::Phantom => todo!(),
            ActorType::IllagerBeast => todo!(),
            ActorType::ArmorStand => todo!(),
            ActorType::TripodCamera => todo!(),
            ActorType::EnderCrystal => todo!(),
            ActorType::FireworksRocket => todo!(),
            ActorType::Trident => todo!(),
            ActorType::Turtle => todo!(),
            ActorType::Cat => todo!(),
            ActorType::ShulkerBullet => todo!(),
            ActorType::FishingHook => todo!(),
            ActorType::Chalkboard => todo!(),
            ActorType::DragonFireball => todo!(),
            ActorType::Arrow => todo!(),
            ActorType::Snowball => todo!(),
            ActorType::ThrownEgg => todo!(),
            ActorType::Painting => todo!(),
            ActorType::LargeFireball => todo!(),
            ActorType::ThrownPotion => todo!(),
            ActorType::Enderpearl => todo!(),
            ActorType::LeashKnot => todo!(),
            ActorType::WitherSkull => todo!(),
            ActorType::BoatRideable => todo!(),
            ActorType::WitherSkullDangerous => todo!(),
            ActorType::LightningBolt => todo!(),
            ActorType::SmallFireball => todo!(),
            ActorType::AreaEffectCloud => todo!(),
            ActorType::LingeringPotion => todo!(),
            ActorType::LlamaSpit => todo!(),
            ActorType::EvocationFang => todo!(),
            ActorType::EvocationIllager => todo!(),
            ActorType::Vex => todo!(),
            ActorType::MinecartRideable => todo!(),
            ActorType::MinecartHopper => todo!(),
            ActorType::MinecartTNT => todo!(),
            ActorType::MinecartChest => todo!(),
            ActorType::MinecartFurnace => todo!(),
            ActorType::MinecartCommandBlock => todo!(),
            ActorType::IceBomb => todo!(),
            ActorType::Balloon => todo!(),
            ActorType::Pufferfish => todo!(),
            ActorType::Salmon => todo!(),
            ActorType::Drowned => todo!(),
            ActorType::Tropicalfish => todo!(),
            ActorType::Fish => todo!(),
            ActorType::Panda => todo!(),
            ActorType::Pillager => todo!(),
            ActorType::VillagerV2 => todo!(),
            ActorType::ZombieVillagerV2 => todo!(),
            ActorType::Shield => todo!(),
            ActorType::WanderingTrader => todo!(),
            ActorType::Lectern => todo!(),
            ActorType::ElderGuardianGhost => todo!(),
            ActorType::Fox => todo!(),
            ActorType::Bee => todo!(),
            ActorType::Piglin => todo!(),
            ActorType::Hoglin => todo!(),
            ActorType::Strider => todo!(),
            ActorType::Zoglin => todo!(),
            ActorType::PiglinBrute => todo!(),
            ActorType::Goat => todo!(),
            ActorType::GlowSquid => todo!(),
            ActorType::Axolotl => todo!(),
            ActorType::Warden => todo!(),
            ActorType::Frog => todo!(),
            ActorType::Tadpole => todo!(),
            ActorType::Allay => todo!(),
            ActorType::ChestBoatRideable => todo!(),
            ActorType::TraderLlama => todo!(),
            ActorType::Camel => todo!(),
            ActorType::Sniffer => todo!(),
            ActorType::Breeze => todo!(),
            ActorType::BreezeWindChargeProjectile => todo!(),
            ActorType::Armadillo => todo!(),
            ActorType::WindChargeProjectile => todo!(),
            ActorType::Bogged => todo!(),
            ActorType::OminousItemSpawner => todo!(),
        }
    }
}
